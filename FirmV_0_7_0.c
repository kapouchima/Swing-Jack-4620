...
while(1)
{
  ...
  if(Flag20ms==1)
  {
     ...
     if(DebouncingDelayPress<DebouncingFix)
       DebouncingDelayPress=DebouncingDelayPress+1;
     if(DebouncingDelayUnpress<DebouncingFix)
...
void State3()
{
  ...
  if(CheckTask(1))
    {StartMotor(1,_Open);Logger("S3 Motor1Start",1); Lock=0;memcpy(LCDLine1,_opening,16);memcpy(LCDLine2,_Blank,16);LCDUpdateFlag=1;LCDLines=1;}

  if(CheckTask(2))
    {StartMotor(2,_Open);Logger("S3 Motor2Start",1); Lock=0;}
...
FlashFlag=1;
  ...
  if(CheckTask(1))
    {StartMotor(1,_Close);Logger("S4 Motor1Start",1);}

  if(CheckTask(2))
    {StartMotor(2,_Close);Logger("S4 Motor2Start",1);memcpy(LCDLine1,_closing,16);memcpy(LCDLine2,_Blank,16);LCDUpdateFlag=1;LCDLines=1;}
...
void State7()
{
  ...
  if(CheckTask(1))
    {StartMotor(1,_Close);Logger("S7 Motor1Start",1);}

  if(CheckTask(2))
    {StartMotor(2,_Close);Logger("S7 Motor2Start",1);memcpy(LCDLine1,_closing,16);memcpy(LCDLine2,_Blank,16);LCDUpdateFlag=1;LCDLines=1;}
...
void State8()
{
  ...
  if(CheckTask(1))
    {StartMotor(1,_Open);Logger("S8 Motor1Start",1); Lock=0;memcpy(LCDLine1,_opening,16);memcpy(LCDLine2,_Blank,16);LCDUpdateFlag=1;LCDLines=1;}

  if(CheckTask(2))
    {StartMotor(2,_Open);Logger("S8 Motor2Start",1); Lock=0;}
...
trisd=0b00111111;
trise=0b001;
adcon1=0b1100;  // an6, an5 and an7 is digital
...
void LearnAuto()
{
  ...
  switch(LearnPhase)
  {
    ...
    case 1: //Start D2 and enable overload sensing after 3s
      StartMotor(2,_Close);AddTask(ms500+6,21);LearnPhase=LearnPhase+1;
      break;
    ...
    case 3: //Start D1 and enable overload sensin after 3 s
      StartMotor(1,_Close);AddTask(ms500+6,20);LearnPhase=LearnPhase+1;;
    ...
    case 5: //Start D1 for opening and save start time and enable overload sensing after 3s
      startT=ms500;StartMotor(1,_Open);AddTask(ms500+6,20);LearnPhase=LearnPhase+1;
      break;
    ...
    case 7: //Start D2 for opening and save start time and enable overload sensing after 3s
      startT=ms500;StartMotor(2,_Open);AddTask(ms500+6,21);LearnPhase=LearnPhase+1;
      break;
    ...
    case 9: //Start D2 for closing and save start time and enable overload sensing after 6s
      startT=ms500;StartMotor(2,_Close);AddTask(ms500+6,21);LearnPhase=LearnPhase+1;
      break;
    ...
    case 11: //Start D1 for closing and save start time and enable overload sensing after 3s
      startT=ms500;StartMotor(1,_Close);AddTask(ms500+6,20);LearnPhase=LearnPhase+1;
      break;
